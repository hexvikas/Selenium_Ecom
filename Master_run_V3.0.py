...
run_id = int(time.time())  # Unique Suite Execution ID
...
# -------------------------
# Generate UNIQUE HTML Report
# -------------------------
report_time = datetime.datetime.now().strftime("%d-%m-%Y %H:%M:%S")

timestamp = datetime.datetime.now().strftime("%d%m%y_%H%M%S")
report_file = f"report_{timestamp}.html"   # UNIQUE FILE NAME
...
<body>
    ...
    <p style="color:#94a3b8;">Report Generated: <b>{report_time}</b></p>
    <p style="color:#94a3b8;">Suite Execution ID: <b>{run_id}</b></p>
